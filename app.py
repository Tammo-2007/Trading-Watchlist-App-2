...
# --- Sidebar: Mandantenverwaltung + Aktie hinzufügen ---
with st.sidebar:
    ...
    if st.button("Hinzufügen"):
        if ticker_input and price_input > 0 and stk_input > 0:
            ...
            st.warning("Bitte alle Pflichtfelder korrekt ausfüllen.")
...
with tab1:
    ...
    if portfolio.empty:
        ...
        # --- Anzeige als Cards mit hellgrauem Hintergrund und dunkler Schrift ---
        ...
        # --- Chart direkt neben jeder Aktie ---
...
with tab2:
    ...
    st.write("Hier können Kennzahlen, erwartetes Portfolio-Hoch, Diversifikation usw. angezeigt werden.")
